...
var cList = ArrayList<Comment>()

class PlaceCommentAdapter(
    private var commentList: ArrayList<Comment>,
    private var placeName: String
) :
    RecyclerView.Adapter<PlaceCommentAdapter.MyViewHolder>() {
    init {
        commentFix()
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.placeName.text = cList[position].placeName
        holder.placeComment.text = cList[position].placeComment
        holder.userName.text = cList[position].userName
        getPhoto(
